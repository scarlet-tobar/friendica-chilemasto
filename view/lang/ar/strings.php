...
$a->strings['Password reset request issued. Check your email.'] = 'أًعد طلب إعادة تعيين كلمه المرور. تحقق من بريدك الإلكتروني.';
$a->strings['
		Dear %1$s,
		...
		issued this request.'] = '
		عزيزي %1$s،
			استلمنا مؤخرًا طلبًا لإعادة تعيين كلمة المرور في "%2$s".
		لتأكيد هذا الطلب، يرجى النقر على رابط التحقق
		أدناه أو لصقه في شريط عناوين متصفحك.

		إذا لم تطلب هذا التغيير، رجاء لاتتبع الرابط
		وتجاهله و/أو حذف هذا البريد الإلكتروني، الطلب سينتهي قريبا.

		لن تُغير كلمة مرورك ما لم نتمكن من التحقق من
		هويتك.';
$a->strings['
		...
		سوف تتلقى ردا بحتوي كلمة المرور الجديدة.
	 يمكنك تغيير كلمة المرور من صفحة إعدادات الحساب بعد الولوج.
		...
		الموقع:	%2$s
		اسم الولوج:	%3$s';
$a->strings['Password reset requested at %s'] = 'طُلب إعادة تعيين كلمة المرور في %s';
$a->strings['Request could not be verified. (You may have previously submitted it.) Password reset failed.'] = 'تعذر التحقق من الطلب ( قد تكون استخدمته مسبقاً). فشلت إعادة تعيين كلمة المرور.';
$a->strings['Request has expired, please make a new one.'] = 'انتهت صلاحية الطلب ، أرسل آخر جديد.';
$a->strings['Forgot your Password?'] = 'نسيت كلمة المرور؟';
$a->strings['Enter your email address and submit to have your password reset. Then check your email for further instructions.'] = 'أدخل عنوان بريدك الإلكتروني لإعادة تعيين كلمة المرور. بعد ذلك راجع الرسالة في بريدك الإلكتروني لمزيد من التعليمات.';
...
$a->strings['
		...
		'] = '
			...
			المعلومات (أو تغيير كلمة المرور لما يناسبك).
				';
$a->strings['
...
$a->strings['Collapse this author\'s posts?'] = 'أتريد طي مشاركات هذا الشخص؟';
...
$a->strings['Quote shared by: %s'] = 'نشر %s اقتبساً.';
$a->strings['Chat'] = 'محادثة';
$a->strings['(no subject)'] = '(بدون موضوع)';
$a->strings['The folder %s must be writable by webserver.'] = 'يتطلب أن يكون للخادم صلاحية الكتابة على مجلد %s.';
$a->strings['Login failed.'] = 'فشل الولوج.';
$a->strings['Login failed. Please check your credentials.'] = 'فشل الولوج. من فضلك تحقق من بيانات الاعتماد.';
$a->strings['Login failed because your account is blocked.'] = 'فشل الولوج ﻷن حسابك محظور.';
...
$a->strings['Always open Compose page'] = 'افتح نافذة طافية دائما';
$a->strings['The New Post button always open the <a href="/compose">Compose page</a> instead of the modal form. When this is disabled, the Compose page can be accessed with a middle click on the link or from the modal.'] = 'سيفتح زر مشاركة جديدة <a href="/compose">صفحة الإنشاء</a> عوض عرض نافذة طافية. عند تعطيل هذا الخيار يمكنك الوصول لصفحة الإنشاء بنقر الزر الأوسط للفأرة أو عبر النافذة طافية.';
