...
$a->strings['To:'] = 'Кому:';
$a->strings['Start typing the name of a contact and select from the list'] = 'Начните набирать имя контакта и выберите из списка';
...
$a->strings['Send Message'] = 'Написать сообщение';
$a->strings['You have no messages.'] = 'У Вас нет сообщений';
...
$a->strings['Upload photo to this album'] = 'Загрузить фото в этот альбом';
$a->strings['Upload selected photo'] = 'Загрузить выбранное фото';
$a->strings['The maximum accepted image size is %s'] = 'Максимально допустимый размер изображения %s';
$a->strings['Upload Photos to %s'] = 'Загрузить фото в %s';
$a->strings['Upload Photos'] = 'Загрузить фото';
$a->strings['Album name: '] = 'Имя альбома: ';
...
$a->strings['Delete photo'] = 'Удалить фото';
$a->strings['Use as profile picture'] = 'Использовать как фото профиля';
...
$a->strings['Back to viewing'] = 'Назад к просмотру';
...
$a->strings['Go to post'] = 'Перейти к записи';
$a->strings['Created at'] = 'Создано';
$a->strings['New Post'] = 'Новая запись';
$a->strings['Post'] = 'Публикация';
...
$a->strings['Add file'] = 'Добавить файл';
...
$a->strings['Stored because of your activity (like, comment, bookmark, ...)'] = 'Загружено из-за ваших действий (лайк, комментарий, закладка...)';
$a->strings['Distributed'] = 'Распространено';
$a->strings['Pushed to us'] = 'Прислано нам';
$a->strings['Channel "%s": %s'] = 'Канал "%s": %s';
$a->strings['Channel "%s"'] = 'Канал "%s"';
...
$a->strings['Bookmarked'] = 'В закладках';
...
$a->strings['Turn on notifications for this post'] = 'Включить уведомления для этой записи';
$a->strings['Fetch more replies'] = 'Загрузить ещё ответов';
...
$a->strings['Ignore user'] = 'Игнорировать';
$a->strings['Block user'] = 'Заблокировать';
$a->strings['Ignore %s server'] = 'Игнорировать сервер %s ';
$a->strings['Detected languages'] = 'Определённые языки';
...
$a->strings['Mark as read'] = 'Отметить прочитанным';
...
$a->strings['Manage other accounts, including groups and pages'] = 'Управление другими аккаунтами, включая группы и страницы';
...
$a->strings['Save search'] = 'Сохранить поиск';
...
$a->strings['%s has blocked you'] = '%s заблокировал вас';
...
$a->strings['Sensitive content'] = 'Чувствительное содержимое';
$a->strings['bytes'] = 'байт';
$a->strings['The media in this post is not displayed to visitors. To view it, please go to the <a href="%s">original post</a>.'] = 'Медиа этой записи не отображаются для посетителей. Для просмотра, пожалуйста, зайдите в <a href="%s">оригинальную запись</a>.';
$a->strings['The media in this post is not displayed to visitors. To view it, please log in.'] = 'Медиа этой записи не отображаются для посетителей. Для просмотра, пожалуйста, зайдите.';
...
$a->strings['View related post'] = 'Просмотр связанной записи';
...
$a->strings['Responsible account: %s'] = 'Ответственный аккаунт: %s';
...
$a->strings['Log settings'] = 'Настройки журнала';
...
$a->strings['Current log path: %s'] = 'Путь к журналу: %s';
...
$a->strings['Deny undetected languages'] = 'Отвергать неопределённые языки';
$a->strings['If enabled, posts with undetected languages will be rejected.'] = 'Если включено, записи с неопределённым языком будут отвергнуты.';
...
$a->strings['Formatting is not supported for this field'] = 'Форматирование не поддерживается в этом поле';
$a->strings['Edit event'] = 'Редактировать мероприятие';
$a->strings['New event'] = 'Новое событие';
$a->strings['Ends'] = 'Окончание';
$a->strings['Back to the calendar'] = 'Назад в календарь';
$a->strings['Starting date and Title are required.'] = 'Необходима дата старта и заголовок.';
$a->strings['Starts'] = 'Начало';
$a->strings['Required'] = 'Требуется';
$a->strings['When does it happen?'] = 'Когда это начинается?';
$a->strings['Further details'] = 'Дополнительно';
$a->strings['Don\'t specify ending'] = 'Не указывать окончание';
$a->strings['Title'] = 'Заголовок';
$a->strings['Location'] = 'Местонахождение';
$a->strings['Where does it happen?'] = 'Где это происходит?';
$a->strings['Description'] = 'Описание';
$a->strings['What are the details?'] = 'Дополнительные детали?';
$a->strings['Event title'] = 'Название события';
...
$a->strings['Mark all as read'] = 'Отметить прочитанным';
...
$a->strings['If you want to always use this editor for posting, you can configure the New Post button to always open it in your <a href="/settings/display">Theme settings</a>.'] = 'Если вы хотите всегда пользоваться этим редактором для записей, вы можете настроить его запуск по кнопке Новая запись в <a href="/settings/display">настройках темы</a>.';
...
$a->strings['Nickname or email'] = 'Ник или адрес электронной почты:';
$a->strings['Reset my password'] = 'Сбросить пароль';
...
$a->strings['Registration Closed'] = 'Регистрация закрыта';
$a->strings['Registration is currently closed on this node.'] = 'В настоящий момент регистрация на этом сервере закрыта.';
$a->strings['The administrators have decided to limit new registrations. This could be temporary or permanent.'] = 'Администраторы закрыли возможность новых регистраций. Это может быть на временной или постоянной основе.';
$a->strings['You can find other open Friendica servers at %s where you can register.'] = 'Вы можете найти другие серверы Friendica с открытой регистрацией в каталоге %s.';
...
$a->strings['Create Account'] = 'Создать аккаунт';
$a->strings['Personal (standard account)'] = 'Личный (обычный аккаунт)';
$a->strings['Soap-Box (auto-approve Follow requests)'] = 'Публичный (автоодобрение подписок)';
$a->strings['Love-All (auto-approve Friend requests)'] = 'Открытый (автоодобрение друзей)';
$a->strings['Organization Page'] = 'Страница организации';
$a->strings['Restricted Group'] = 'Закрытая группа';
$a->strings['Create Group'] = 'Создать группу';
$a->strings['Create Page'] = 'Создать страницу';
$a->strings['Personal Soap-Box (auto-approve Follow requests)'] = 'Личный (с автоодобрением подписок)';
$a->strings['Personal Love-All (auto-approve Friend requests)'] = 'Личный (с автодобавлением друзей)';
$a->strings['Account type:'] = 'Тип учётной записи:';
$a->strings['You can change the account type later. (<a href="'] = 'Вы можете сменить тип аккаунта позже. (<a href="';
...
$a->strings['Post expiration'] = 'Истечение записей';
...
$a->strings['Expire bookmarked posts'] = 'Удалять записи в закладках';
$a->strings['Bookmarking posts keeps them from being expired. That behaviour is overwritten by this setting.'] = 'Добавление записей в закладки защищает их от удаления. Эта настройка выключает эту защиту.';
...
$a->strings['Minimal Posting Interval'] = 'Минимальный интервал публикации';
$a->strings['The minimum interval in minutes between two posts. Default is 0. If enabled, your own posts are automatically delayed by the specified number of minutes.'] = 'Минимальная задержка между записями. По-умолчанию 0. Если включить, ваши записи будут автоматически задерживаться на это число минут, если публикуются подряд.';
...
$a->strings['Display emojis'] = 'Показывать эмодзи';
$a->strings['When enabled, emoticons are replaced with matching emojis.'] = 'Когда включено, соответствующие символы заменятся на графические смайлики.';
...
$a->strings['Channels Widget'] = 'Виджет каналов';
$a->strings['Top Menu'] = 'Верхнее меню';
...
$a->strings['Filter channels:'] = 'Фильтр каналов:';
$a->strings['Select all the channels that you want to use as a filter for your network timeline. All posts from these channels will be hidden. For technical reasons postings that are older than %s will not be filtered.'] = 'Выберите все каналы, которые вы хотите использовать как фильтр основной ленты. Все записи из этих каналов будут скрыты. По техническим причинам записи старше %s не будут отфильтрованы.';
...
$a->strings['Used for suggesting potential friends, can be seen by others.'] = 'Используется для поиска потенциальных друзей, другие могут это видеть.';
$a->strings['Private Keywords:'] = 'Личные ключевые слова:';
$a->strings['Used for searching profiles, never shown to others.'] = 'Используется при поиске профилей, никогда не показывается другим.';
...
$a->strings['Pinned to your wall'] = 'Закреплено на вашей странице';
...
$a->strings['Report this post'] = 'Пожаловаться на запись';
$a->strings['Save to folder'] = 'Сохранить в папку';
$a->strings['I will attend'] = 'Я буду';
$a->strings['I will not attend'] = 'Меня не будет';
$a->strings['I might attend'] = 'Возможно';
$a->strings['Turn off related notifications'] = 'Отключить уведомления';
$a->strings['Turn on related notifications'] = 'Включить уведомления';
$a->strings['Notifications turned off for this post'] = 'Уведомления для этой записи отключены';
$a->strings['Bookmark'] = 'Закладка';
$a->strings['Remove bookmark'] = 'Удалить закладку';
$a->strings['Starred'] = 'Избранное';
$a->strings['Pin to your wall'] = 'Закрепить';
$a->strings['Unpin from your wall'] = 'Открепить';
$a->strings['Add tag to post'] = 'Добавить тег к записи';
...
$a->strings['Post comment'] = 'Комментировать';
$a->strings['Chat'] = 'Чат';
...
$a->strings['Login failed because your account is blocked.'] = 'Вход запрещён, так как ваш аккаунт заблокирован.';
